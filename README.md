...
## Setup
* Create a new repo [using this template](https://github.com/byu-oit/ceslinkaccount/generate).

  You need your own repo so that you can push changes and have CodePipeline deploy them.
  
  Keep your repo name relatively short. Since we're creating AWS resources based off the name, we've seen [issues with repo names longer than about 24 characters](https://github.com/byu-oit/ceslinkaccount/issues/22).
...
* Find and replace across the repo:
  ...
  * replace `ceslinkaccount` with the name of your repo
